...
pub fn render(pal: &Palette, frame: &mut Frame, area: Rect) {
    ...
    let lines = vec![
        ...
        Line::from("  header shows ⊙ synced / ○ local"),
        Line::from("  favourites + blocklist sync automatically once linked"),
        Line::from("  y opens the panel: create key, show qr, copy,"),
        Line::from("    re-sync, log out, delete account"),
        Line::from("  scan the panel qr in the phone app to pair"),
